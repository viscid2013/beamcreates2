...
<img src="../branding_icons/projectTemp.png" alt="man project managing" style="max-width: 50%;" />
	<div>
		...
		<h3 class="w3-padding-small w3-border-bottom w3-border-top w3-text-theme" style="font-weight: bold;">Wake County Public Libraries Projects</h3>
			<p style="font-style: italic; font-weight: bold;">Tranfer of Library Servers to County Datacenter</p>
				<p>My role: </p>
			...
			<p style="font-style: italic; font-weight: bold;">Coordination with Marketing Firm</p>
				<p>My role: </p>
				<p>Co-Project Lead for Libraries along the Library Deputy Director</p>
				<p>Other roles:</p>
				<ul>
					...
					<li>Libraries Liaison with County Communications Office: represented County interests in external marketing and branding</li>
					<li>Project manager from the marketing firm</li>
					<li>Media and Creative consultants from the marketing firm</li>
				</ul>
				<p>Summary: </p>
					<p>While the libraries have a strong marketing and awareness team for internal promotion and branding of library programs and services, we have traditionally lacked the time and resources for a large, traditional, external campaign. To this end, we experimented with a short term partnership with an external marketing firm to explore new avenues of promotion and raising awareness of our libraries. There were interesting challenges with coordinating efforts, integrating our already distinctive design efforts with the styles presented by the firm, finding ways to adjust techniques and methods for a government entity, and libraries in particular. The County had certain standards and requirements to maintain, for example. Overall, it was a a great learning experience, and even after the contract ended, we ended up with a mix of validation of previous efforts and new tools and methods to apply going forward. </p>

			<p style="font-style: italic; font-weight: bold;">Restructure of Library Technology Department</p>
				<p>My role: </p>
