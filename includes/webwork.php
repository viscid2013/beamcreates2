...
<img src="../branding_icons/mecoding.png" alt="bearded coding" style="max-width: 50%;" />
	<div>
		...
		<p class="w3-padding-small w3-border-bottom" style="font-weight: 400;">Web Work with the Public Libraries</p>
		...
		<p class="w3-padding-small w3-border-bottom" style="font-weight: 400;">Personal Projects</p>
